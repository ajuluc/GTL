...
simpleReactor(
    ...
    initialMoleFractions={
        # "n-pch": 0.015748, # phi = 1
        "n-pch": [0.015748/2, 0.015748*2], # range of 0.5 < phi < 2
        "N2": 0.787402,
        "O2": 0.19685,
        },
...
# first stage with a lower tolerance of maxNumSpecies=200
...
# second stage with a lower tolerance of maxNumSpecies=400
